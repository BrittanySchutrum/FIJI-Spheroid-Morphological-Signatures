...
1) [ConvexityMacro.ijm](ConvexityMacro.ijm.md) = calculates the convexity (the convex perimeter divided by the perimeter) for each ROI open in the ROI manager 
